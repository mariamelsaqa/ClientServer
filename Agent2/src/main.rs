...
fn main() {
    ...
    let mut current_bool = s3;
    let socket = UdpSocket::bind("10.7.57.88:8084").expect("Server Could not bind socket");
    let socket2 = UdpSocket::bind ("10.7.57.88:8085").expect("server Could not bind socket");
    let socket_bool1 = UdpSocket::bind ("10.7.57.88:8086").expect("server Could not bind socket");
    let socket_bool2 = UdpSocket::bind ("10.7.57.88:8087").expect("server Could not bind socket");
    let socket_bool3 = UdpSocket::bind ("10.7.57.88:8088").expect("server Could not bind socket");
    ...
    loop
    {
        ...
        let handle =thread::spawn(move||  {
            ...
            sock.send_to(&buf[..amt2],"10.7.57.88:8081").expect("error sending msg");
